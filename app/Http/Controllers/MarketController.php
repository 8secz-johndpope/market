...
class MarketController extends BaseController
{
    ...
    public function suggest(Request $request)
    {
        ...
        return ['q'=>$request->q,'suggestions'=>[['value'=>'Hello','data'=>'HE'],['value'=>'Samsung','data'=>'HE'],['value'=>'iPhone','data'=>'HE']]];
        $term = $request->term;
        $params = [
            'index' => 'suggest',
            'type' => 'complete',
...
// Update doc at /my_index/my_type/my_id
    ...
    public function filter($request,$category){
        ...
        return ['sorts'=>$sorts,'prices'=>$prices,'distances'=>$distances,'url'=>$request->url(),'input'=>$input,'lat'=>$lat,'lng'=>$lng,'max'=>$max,'pages'=>$pages,'total'=>$total,'page'=>$page,'category'=>$category,'products'=>$products,'breads'=>$breads,'last'=>$any,'base'=>$base,'chs'=>$chs,'filters'=>$filters];
    }
