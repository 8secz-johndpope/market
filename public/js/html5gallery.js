 ...
 */
(function() {
    for (var v = document.getElementsByTagName("script"), w = "", n = 0; n < v.length; n++)
        v[n].src && v[n].src.match(/html5gallery\.js/i) && (w = v[n].src.substr(0, v[n].src.lastIndexOf("/") + 1));
    v = !1;
    if ("undefined" == typeof jQuery)
        v = !0;
    else if (n = jQuery.fn.jquery.split("."),
    1 > n[0] || 1 == n[0] && 6 > n[1])
        v = !0;
    if (v) {
...
function loadHtml5Gallery(v) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInElastic: function(b, e, a, c, d) {
            ...
            j || (j = 0.3 * d);
            f < Math.abs(c) ? (f = c,
            b = j / 4) : b = j / (2 * Math.PI) * Math.asin(c / f);
        ...
        easeInOutElastic: function(b, e, a, c, d) {
            ...
            f < Math.abs(c) ? (f = c,
            b = j / 4) : b = j / (2 * Math.PI) * Math.asin(c / f);
            return 1 > e ? -0.5 * f * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * d - b) * 2 * Math.PI / j) + a : 0.5 * f * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * d - b) * 2 * Math.PI / j) + c + a
        },
    ...
    w.fn.touchSwipe = function(b) {
        ...
        return this.each(function() {
            function a(a) {
                ...
                h = b.targetTouches[0].pageY) : j(a)
            }
            function b(a) {
                var d = e.preventWebBrowser
                  , c = a.originalEvent;
                1 <= c.targetTouches.length ? (p = c.targetTouches[0].pageX,
                g = c.targetTouches[0].pageY,
                e.instance && e.preventWebBrowserCallback && (d = e.instance[e.preventWebBrowserCallback](g < h))) : j(a);
                d && a.preventDefault()
            }
            function d(a) {
                if (0 < p || 0 < g)
                    100 < Math.abs(p - f) && (p > f ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()),
                    100 < Math.abs(g - h) && (g > h ? e.swipeBottom && e.swipeBottom.call() : e.swipeTop && e.swipeTop.call());
                j(a)
            }
            function j() {
                g = p = h = f = -1
            ...
            var f = -1
              ...
              , g = -1;
            try {
                w(this).on("touchstart", a),
                w(this).on("touchmove", b),
                w(this).on("touchend", d),
                w(this).on("touchcancel", j)
            } catch (t) {}
        })
    }
    ;
    ...
    var u = n.event
      ...
      , k = s.drag = {
        ...
        teardown: function() {
            n.data(this, k.datakey).related || (n.removeData(this, k.datakey),
        ...
        handler: function(b) {
            ...
            case "mouseup":
                ...
                e.dragging && (!1 !== e.drop && s.drop && s.drop.handler(b, e),
        ...
        hijack: function(b, e, a, c, d) {
            if (a) {
                var j = b.originalEvent, f = b.type, h = e.indexOf("drop") ? "drag" : "drop", p, g = c || 0, t, q;
                c = !isNaN(c) ? c : a.interactions.length;
                b.type = e;
                b.originalEvent = null;
                a.results = [];
                do
                    if ((t = a.interactions[g]) && !("dragend" !== e && t.cancelled))
                        q = k.properties(b, a, t),
                        t.results = [],
                        n(d || t[h] || a.droppable).each(function(c, d) {
                            q.target = d;
                            p = u.handle ? d ? u.handle.call(d, b, q) : null : d ? u.dispatch.call(d, b, q) : null;
                            !1 === p ? ("drag" == h && (t.cancelled = !0,
                            a.propagates -= 1),
                            "drop" == e && (t[h][c] = null)) : "dropinit" == e && t.droppable.push(k.element(p) || d);
                        ...
                        a.results[g] = k.flatten(t.results),
                        "dropinit" == e && (t.droppable = k.flatten(t.droppable)),
                        "dragstart" == e && !t.cancelled && q.update();
                while (++g < c);b.type = f;
                b.originalEvent = j;
    ...
    y.fn.html5boxTransition = function(b, e, a, c, d) {
        ...
        p = y.trim(p.toLowerCase()));
        p && c[p] && ("duration"in c[p] && (f = c[p].duration),
        c[p].easing && (j = c[p].easing));
        "fade" == p || "fadein" == p ? (a.hide(),
        e.insertBefore(a),
        a.fadeIn(f, j, function() {
            e.remove();
            d()
        })) : "fadeout" == p ? (a.show(),
        e.fadeOut(f, j, function() {
            e.remove();
            d()
        })) : "fadeinout" == p ? (a.hide(),
        e.insertBefore(a),
        ...
        if (!k && (m.get(0).requestFullscreen || m.get(0).webkitRequestFullScreen || m.get(0).mozRequestFullScreen || m.get(0).webkitEnterFullScreen || m.get(0).msRequestFullscreen)) {
            var L = function(a) {
                if (a) {
                    ...
                    var b = null != navigator.userAgent.match(/MSIE/i) && !this.options.isOpera;
              ...
              , N = function(a) {
                ...
                a ? (l(document).on("mousemove", y),
                x.css({
                    "z-index": 2147483647
                })) : (l(document).off("mousemove", y),
                x.css({
                    "z-index": ""
                }))
            };
            document.addEventListener("MSFullscreenChange", function() {
                ...
                if (a || b)
                    t || m.get(0).removeAttribute("controls");
                N(t)
            }, !1);
            ...
            document.addEventListener("webkitfullscreenchange", function() {
                ...
                null != navigator.userAgent.match(/Android/i) ? t ? m.get(0).setAttribute("controls", "controls") : (m.get(0).removeAttribute("controls"),
                N(document.webkitIsFullScreen)) : N(document.webkitIsFullScreen)
            }, !1);
    ...
    b.fn.html5gallery = function(k) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                0 >= a.elemArray.length || (a.createSliderTimeout(),
                a.createEvents(),
                a.loadCarousel(),
                a.savedElem = -1,
                a.curElem = -1,
                ...
                a.slideRun(d),
                a.options.responsive && (a.resizeGallery(),
                b(window).resize(function() {
                    if (a.options.isMobile && !a.options.mobileresizeevent)
            ...
            readTags: function() {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    ...
                    t = b(this).parent().data("ogg"),
                    q = b(this).parent().data("webm"),
                    k = b(this).parent().data("link"),
                    l = b(this).parent().data("linktarget"),
                    n = b(this).parent().data("poster"),
                    isNaN(b(this).parent().data("width")) || (h = b(this).parent().data("width")),
                    isNaN(b(this).parent().data("height")) || (p = b(this).parent().data("height")),
                    u = b(this).parent().data("hd"),
                    m = b(this).parent().data("hdogg"),
                    v = b(this).parent().data("hdwebm"),
                    w = b(this).parent().data("lightboxwidth"),
                    s = b(this).parent().data("lightboxheight"),
                    x = b(this).parent().data("youtubeapikey"),
                    y = b(this).parent().data("youtubeplaylistid"),
                    A = b(this).parent().data("youtubeplaylistmaxresults"),
                    D = b(this).parent().hasClass("html5gallerylightbox"));
                ...
                b.getJSON(g, function(b) {
                    if (b && b.items)
                        for (var g = 0; g < b.items.length; g++) {
                            ...
                            0 <= e ? (h.elemArray.splice(e, 0, p),
                            e++) : h.elemArray.push(p)
                        }
                    b && (b.nextPageToken && d && 50 < d) && (t = !1,
                    h.getYouTubePlaylist(a, c, d - 50, e, f, h, b.nextPageToken))
                }).always(function() {
                    t && f(h)
                })
            },
            ...
            resizeStyleVertical: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        var c = this.showingPoster ? this.elemArray[this.curElem][23] : this.elemArray[this.curElem][10], a = this.showingPoster ? this.elemArray[this.curElem][24] : this.elemArray[this.curElem][11], d;
                        if (this.isFullscreen) {
                            ...
                            d = "fill" == this.options.resizemode ? Math.max(this.options.width / c, this.options.height / a) : Math.min(this.options.width / c, this.options.height / a);
                        e = Math.round(d * c);
                        c = Math.round(d * a);
                        ...
                        a = this.elemArray[this.curElem][10],
                        c = this.elemArray[this.curElem][11],
                        this.isFullscreen ? (e = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth,
                        d = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight,
                        d = Math.min(e / a, d / c),
                        d = 1 < d ? 1 : d,
                        a = Math.round(d * a),
                        d = Math.round(d * c),
                        this.adjustFullscreen(a, d, !0)) : (a = this.options.width,
                        ...
                        e = this.options.isIPhone ? d - 48 : d,
                        ...
                        b("#html5gallery-elem-video-" + this.id).attr("width", a),
                        b("#html5gallery-elem-video-" + this.id).attr("height", d),
                        b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", a),
                        b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", d),
                        b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", a),
                        b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", d);
                    d = e = 0;
                    "bottom" == this.options.headerpos && (e = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height,
            ...
            createStyleVertical: function() {
                ...
                d = this.options.isMobile ? d + (" .html5gallery-car-left-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:16px; height:35px; left:" + String(this.options.thumbwidth + 5) + "px; top:0px; background:url('" + this.options.skinfolder + "slidertop.png')}  .html5gallery-car-right-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:16px; height:35px; left:" + String(this.options.thumbwidth + 5) + "px; top:" + String(this.options.thumbMaskHeight - 35) + "px; background:url('" + this.options.skinfolder + "sliderbottom.png')} ") : d + (" .html5gallery-car-slider-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; overflow:hidden; cursor:pointer; top:0px; height:54px; left:" + String(this.options.thumbwidth + 5) + "px; width:16px; background:url('" + this.options.skinfolder + "slider.png');}"),
                a = 0,
                this.options.carouselNavButton && (a = Math.round(this.options.carAreaLength / 2 - this.options.thumbMaskHeight / 2)),
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.thumbheight = this.options.thumbsmallheight) : a < this.options.thumbmediumsize ? (this.options.thumbwidth = this.options.thumbmediumwidth,
                    this.options.thumbheight = this.options.thumbmediumheight) : (this.options.thumbwidth = this.options.thumboriginalwidth,
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        a = this.options.isIPhone ? c - 48 : c,
                        b(".html5gallery-elem-video-container-" + this.id).find("video").css({
                            width: d + "px",
                            height: a + "px"
                        }),
                    ...
                    a = "100%",
                    e = "auto",
                    c = b(".html5gallery-tn-image-" + this.id).data("originalwidth"),
                    f = b(".html5gallery-tn-image-" + this.id).data("originalheight"),
                    0 < c && 0 < f && (e = Math.max(this.options.thumbimagewidth / c, this.options.thumbimageheight / f),
                    a = Math.round(e * c) + "px",
                    e = Math.round(e * f) + "px"),
                    ...
                    1 > a && (a = 1),
                    d = (this.options.width - a * this.options.thumbwidth - (a - 1) * this.options.thumbgap) / 2,
                    ...
                    this.options.thumbTotalWidth = this.elemArray.length * this.options.thumbwidth + (this.elemArray.length - 1) * this.options.thumbgap,
                    d = 0,
                    this.options.thumbMaskWidth > this.options.thumbTotalWidth && (d = this.options.thumbMaskWidth / 2 - this.options.thumbTotalWidth / 2 - this.options.thumbgap / 2),
            ...
            createStyleDefault: function() {
                ...
                a += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (a += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading.gif') no-repeat top right;}",
            ...
            slideRun: function(a, c, d, e) {
                ...
                if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                    ...
                    if (this.isFullscreen) {
                        ...
                        this.options.showtitle && (h = "",
                        a && (h += "<div class='html5gallery-title-text-" + this.id + "'>" + a + "</div>"),
                        this.options.showdescription && f && (h += "<div class='html5gallery-description-text-" + this.id + "'>" + f + "</div>"),
                        b(".html5gallery-title-" + this.id, this.$gallery).html(h));
                ...
                if (!(0 > a)) {
                    ...
                    (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) && !d && this.elemArray[this.curElem][12] ? (this.showingPoster = !0,
                    this.showPoster()) : (b(".html5gallery-video-play-" + this.id, p).length && b(".html5gallery-video-play-" + this.id, p).remove(),
                    1 == a ? this.showImage() : (this.options.hidetitlewhenvideoisplaying && b(".html5gallery-title-" + this.id, p).hide(),
            ...
            showImage: function() {
                ...
                b(d).on("load", function() {
                    ...
                    var h = c.isFullscreen ? e : c.options.width
                      , p = c.isFullscreen ? d : c.options.height
                    ...
                    e = b("<div class='html5gallery-elem-img-" + c.id + "' style='display:block; position:absolute; overflow:hidden; width:" + h + "px; height:" + p + "px; left:0px; margin-left:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + c.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + g + "px; top:" + k + "px; max-width:none; max-height:none; width:" + e + "px; height:" + d + "px;' src='" + c.elemArray[c.curElem][2] + "' />" + c.options.watermarkcode + "</div>");
            ...
            adjustFullscreen: function(a, c, d) {
                ...
                var h = Math.max(f, b(document).height())
                  , p = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth
            ...
            showPoster: function() {
                ...
                b(h).on("load", function() {
                    ...
                    h = Math.max(g / this.width, k / this.height),
                    h = 1 < h ? 1 : h) : (h = "fill" == d.options.resizemode ? Math.max(d.options.width / this.width, d.options.height / this.height) : Math.min(d.options.width / this.width, d.options.height / this.height),
                    g = d.options.width,
                    k = d.options.height);
                    ...
                    g = b("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" + g + "px; height:" + k + "px; left:0px; margin-left:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + d.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + n + "px; top:" + u + "px; max-width:none; max-height:none; width:" + l + "px; height:" + h + "px;' src='" + d.elemArray[d.curElem][12] + "' />" + d.options.watermarkcode + "</div>");
                    ...
                    if (!b(".html5gallery-video-play-" + d.id, a).length)
                        b("<div class='html5gallery-video-play-" + d.id + "' style='position:absolute;display:block;cursor:pointer;top:50%;left:50%;width:64px;height:64px;margin-left:-32px;margin-top:-32px;background:url(\"" + d.options.skinfolder + "playvideo_64.png\") no-repeat center center;'></div>").appendTo(c).off(d.eClick).on(d.eClick, function() {
            ...
            showVideo: function(a, c) {
                ...
                if (this.isHTML5) {
                    ...
                    if (this.options.isFirefox || this.options.isOpera)
                        this.elemArray[this.curElem][4] ? k = this.elemArray[this.curElem][4] : this.elemArray[this.curElem][3] && (k = this.elemArray[this.curElem][3]),
                    ...
                    "/" != h.charAt(0) && ("http:" != h.substring(0, 5) && "https:" != h.substring(0, 6)) && (h = this.options.htmlfolder + h),
                    k = "",
                    this.elemArray[this.curElem][13] && (k = this.elemArray[this.curElem][13],
                    "/" != k.charAt(0) && ("http:" != k.substring(0, 5) && "https:" != k.substring(0, 6)) && (k = this.options.htmlfolder + k)),
                    f = {
                        width: f,
                        height: e,
            ...
            initYoutubeApi: function() {
                ...
                for (a = 0; a < this.elemArray.length; a++)
                    9 == this.elemArray[a][9] ? b = !0 : 10 == this.elemArray[a][9] && (d = !0);
            ...
            showYoutube: function(a) {
                ...
                if (ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7) {
                    ...
                    this.ytPlayer = new YT.Player("html5gallery-elem-video-" + this.id,{
                        ...
                        events: {
                            ...
                            onStateChange: function(a) {
                                a.data == YT.PlayerState.ENDED && (h.onVideoEnd(),
                                h.isPaused || h.slideRun(-1))
                            }
                        }
                    })
                } else
                    ...
                    h.options.videohidecontrols && (f += "&controls=0&showinfo=0"),
                    b("#html5gallery-elem-video-" + this.id, c).html("<iframe width='" + e + "' height='" + d + "' src='" + f + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                this.options.googleanalyticsaccount && window._gaq && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][2]])
            },
            ...
            checkType: function(a) {
                return !a ? -1 : a.match(/\.(jpg|gif|png|bmp|jpeg)(.*)?$/i) ? 1 : a.match(/[^\.]\.(swf)\s*$/i) ? 2 : a.match(/[^\.]\.(mp3)\s*$/i) ? 3 : a.match(/[^\.]\.(pdf)\s*$/i) ? 4 : a.match(/\.(flv)(.*)?$/i) ? 5 : a.match(/\.(mp4|m4v)(.*)?$/i) ? 6 : a.match(/\.(ogv|ogg)(.*)?$/i) ? 7 : a.match(/\.(webm)(.*)?$/i) ? 8 : a.match(/\:\/\/.*(youtube\.com)/i) || a.match(/\:\/\/.*(youtu\.be)/i) ? 9 : a.match(/\:\/\/.*(vimeo\.com)/i) ? 10 : a.match(/\:\/\/.*(dailymotion\.com)/i) || a.match(/\:\/\/.*(dai\.ly)/i) ? 11 : 1
            },
            onChange: function() {
            ...
            embedHTML5Video: function(a, c, d, e, f, h, k, g) {
                var l = this;
                if ((this.options.isIE11 || this.options.isIE) && this.options.usenativehtml5controlsonie || this.options.isFirefox && this.options.usenativehtml5controlsonfirefox || this.options.isAndroid && this.options.usenativehtml5controlsonandroid)
                ...
                b("video", a).addHTML5VideoControls(this.options.skinfolder, this, "html5gallery-elem-html5-video-" + this.id));
        ...
        this.each(function() {
            ...
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                var j = {
                  ...
                  , s = "vertical" == this.options.skin ? b.extend(s, u) : "verticallight" == this.options.skin ? b.extend(s, q) : "showcase" == this.options.skin ? b.extend(s, w) : "light" == this.options.skin ? b.extend(s, j) : "gallery" == this.options.skin ? b.extend(s, h) : "gallerywithtext" == this.options.skin ? b.extend(s, l) : "gallerywithtextbottom" == this.options.skin ? b.extend(s, g) : "horizontal" == this.options.skin ? b.extend(s, c) : "darkness" == this.options.skin ? b.extend(s, n) : "mediapage" == this.options.skin ? b.extend(s, f) : b.extend(s, c);
                ...
                if (this.options.screenquery)
                    for (c in this.options.screenquery)
                        j <= this.options.screenquery[c].screenwidth && (this.options.screenquery[c].gallerywidth && (this.options.width = this.options.screenquery[c].gallerywidth),
                ...
                "galleryid"in this.options ? c = this.options.galleryid : (c = D,
                D++);
...
function HTML5GallerySWFObjectFunc() {
        ...
        if (0 < b)
            for (var c = 0; c < b; c++) {
                ...
                if (0 < r.pv[0]) {
                    var m = e(g);
                    if (m)
                        if (a(I[c].swfVersion) && !(r.wk && 312 > r.wk))
                            d(g, !0),
                            h && (j.success = !0,
                            j.ref = s(g),
                            h(j));
                ...
                h) {
                    if ((g = s(g)) && typeof g.SetVariable != f)
                        j.success = !0,
                        j.ref = g;
                    h(j)
                }
    ...
    function k() {
        return !J && a("6.0.65") && (r.win || r.mac) && !(r.wk && 312 > r.wk)
    }
    function y(a, c, d, h) {
        J = !0;
        x = h || null;
        ...
        if (j) {
            ...
            h = "MMredirectURL=" + t.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + h + "&MMdoctitle=" + q.title;
            c.flashvars = typeof c.flashvars != f ? c.flashvars + ("&" + h) : h;
            r.ie && (r.win && 4 != j.readyState) && (h = q.createElement("div"),
            d += "SWFObjectNew",
            h.setAttribute("id", d),
    ...
    function D(a, b, c) {
        ...
        if (g)
            ...
            r.ie && r.win) {
                ...
                for (var n in a)
                    a[n] != Object.prototype[n] && ("styleclass" == n.toLowerCase() ? l.setAttribute("class", a[n]) : "classid" != n.toLowerCase() && l.setAttribute(n, a[n]));
                for (j in b)
                    b[j] != Object.prototype[j] && "movie" != j.toLowerCase() && (a = l,
                    k = j,
                    n = b[j],
    ...
    function U(a) {
        var b = e(a);
        b && "OBJECT" == b.nodeName && (r.ie && r.win ? (b.style.display = "none",
        function() {
            if (4 == b.readyState) {
                var c = e(a);
                if (c) {
    ...
    function c(a, b, c, d) {
        if (!r.ie || !r.mac) {
            ...
            if (e) {
                ...
                d && (T = B = null);
                if (!B || T != c)
                    d = q.createElement("style"),
                    d.setAttribute("type", "text/css"),
                    d.setAttribute("media", c),
                    B = e.appendChild(d),
                    r.ie && (r.win && typeof q.styleSheets != f && 0 < q.styleSheets.length) && (B = q.styleSheets[q.styleSheets.length - 1]),
                    T = c;
    ...
    var f = "undefined", h = "object", p = "application/x-shockwave-flash", g = "SWFObjectExprInst", t = window, q = document, H = navigator, V = !1, M = [function() {
        if (V) {
            ...
            if (c) {
                ...
                (function() {
                    if (typeof c.GetVariable != f) {
                        ...
                        e && (e = e.split(" ")[1].split(","),
                        r.pv = [parseInt(e[0], 10), parseInt(e[1], 10), parseInt(e[2], 10)])
                    } else if (10 > d) {
                        d++;
                        setTimeout(arguments.callee, 10);
                        return
    ...
    ], I = [], m = [], O = [], Q, R, x, W, A = !1, J = !1, B, T, C = !0, r, S = typeof q.getElementById != f && typeof q.getElementsByTagName != f && typeof q.createElement != f, K = H.userAgent.toLowerCase(), L = H.platform.toLowerCase(), N = L ? /win/.test(L) : /win/.test(K), L = L ? /mac/.test(L) : /mac/.test(K), K = /webkit/.test(K) ? parseFloat(K.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, G = !+"\v1", F = [0, 0, 0], z = null;
    if (typeof H.plugins != f && typeof H.plugins["Shockwave Flash"] == h) {
        if ((z = H.plugins["Shockwave Flash"].description) && !(typeof H.mimeTypes != f && H.mimeTypes[p] && !H.mimeTypes[p].enabledPlugin))
            V = !0,
            G = !1,
            z = z.replace(/^.*\s+(\S+\s+\S+$)/, "$1"),
            F[0] = parseInt(z.replace(/^(.*)\..*$/, "$1"), 10),
            F[1] = parseInt(z.replace(/^.*\.(.*)\s.*$/, "$1"), 10),
            F[2] = /[a-zA-Z]/.test(z) ? parseInt(z.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    } else if (typeof t.ActiveXObject != f)
        try {
            var E = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if (E && (z = E.GetVariable("$version")))
                G = !0,
                z = z.split(" ")[1].split(","),
    ...
    r.w3 && ((typeof q.readyState != f && "complete" == q.readyState || typeof q.readyState == f && (q.getElementsByTagName("body")[0] || q.body)) && v(),
    A || (typeof q.addEventListener != f && q.addEventListener("DOMContentLoaded", v, !1),
    r.ie && r.win && (q.attachEvent("onreadystatechange", function() {
        "complete" == q.readyState && (q.detachEvent("onreadystatechange", arguments.callee),
        v())
    }),
    t == top && function() {
        if (!A) {
    ...
    return {
        ...
        embedSWF: function(b, c, e, g, j, l, m, n, p, q) {
            ...
            r.w3 && !(r.wk && 312 > r.wk) && b && c && e && g && j ? (d(c, !1),
            w(function() {
                e += "";
                g += "";
                var r = {};
        ...
        expressInstallCallback: function() {
            if (J) {
                var a = e(g);
                a && Q && (a.parentNode.replaceChild(Q, a),
                R && (d(R, !0),
                r.ie && r.win && (Q.style.display = "block")),
                x && x(W));
                J = !1
            }
        }
