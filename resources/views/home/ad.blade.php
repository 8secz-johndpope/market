                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 location-selected" @if($advert->postcode_id===0) style="display: none" @endif>
                            ...
                            <input  type="checkbox" name="showmap" id="showmap"  value="1"  @if($advert->has_param('showmap')) checked @endif><span class="delivery-text">Display map on the advert &nbsp;&nbsp; </span>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="price" class="form-control  mb-2 mr-sm-2 mb-sm-0" placeholder="Price"  value="@if($advert->has_meta('price')&&$advert->meta('price')>=0){{$advert->price()}}@endif" step="any">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="well">
                                            <p class="bold-text">What shoudl your Buyer Pay for Local Delivery?</p>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-gbp"></i></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="well">
                                            ...
                                            <p class="bold-text">What should your Buyer Pay for Nationwide Shipping?</p>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-gbp"></i></span>
                                                <input type="number" name="buyer_pays" id="buyer_pays"  class="form-control  mb-2 mr-sm-2 mb-sm-0" placeholder="" @if($advert->has_param('freeshipping')&&$advert->param('freeshipping')===1) disabled @endif  value="@if($advert->has_param('freeshipping')&&$advert->param('freeshipping')===1) 0.00 @elseif($advert->has_meta('shipping')&&$advert->meta('shipping')>=0){{$advert->shipping_cost()}}@endif" step="any">
                                            </div>
                                            <br>
