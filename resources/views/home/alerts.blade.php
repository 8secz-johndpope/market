        ...
        <div class="col-sm-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item active">
                    <a class="nav-link nav-color" href="#"><span class="glyphicon glyphicon-bell"></span> &nbsp;&nbsp; Search Alerts</a>
                </li>
                <li class="nav-item">
          ...
          <ul class="list-group">
              @foreach($user->alerts as $alert)
                  <li class="list-group-item">
                      ...
                      <br>
                      <label class="switch">
                          <input class="search-alert-check" type="checkbox" @if($alert->active===1) checked @endif value="{{$alert->id}}">
