...
<span class="hide-visually">This ad is </span>Urgent
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                          ...
                          {{$address->line1}},{{$address->city}},{{$address->postcode}}@if(!$advert->can_deliver_to($address->zip))<span class="red-text"> @else <span class="green-text"> @endif ({{$advert->distance($address->zip) }} Miles)@if(!$advert->can_deliver_to($address->zip))Outside of the delivery area @else Can Deliver</span>@endif
                        </label>
                    </div>
                    @endforeach
                    ...
                    @foreach($user->addresses as $address)
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="billing_address" id="exampleRadios1" value="option1" @if($user->default_address===$address->id) checked @endif>
