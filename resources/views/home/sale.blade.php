...
<span class="hide-visually">This ad is </span>Urgent
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" @if(!$advert->can_deliver_to($address->zip)) disabled @endif><span class="red-text">Outside of the delivery area</span>
