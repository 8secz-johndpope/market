...
<span class="hide-visually">This ad is </span>Urgent
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                          ...
                          {{$address->line1}},{{$address->city}},{{$address->postcode}}@if(!$advert->can_deliver_to($address->zip))<span class="red-text"> @else <span class="green-text"> @endif  @if(!$advert->can_deliver_to($address->zip))Outside of the delivery area @else Can Deliver({{$advert->distance($address->zip) }} Miles)</span>@endif
                        </label>
                    </div>
                    @endforeach
