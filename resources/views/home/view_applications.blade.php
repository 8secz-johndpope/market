    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            @foreach($job->applications as $application)
                <tr><td>{{$application->user->name}}</td><td>{{$application->user->phone}}</td><td>{{$application->cover->cover}}</td><td>{{$application->cv->file_name}}</td><td><a href="/job/profile/view/{{$application->user_id}}">View Profile</a></td></tr>
            @endforeach
            </table>
        </div>
    </div>
