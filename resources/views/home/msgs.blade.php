@foreach($cur->messages as $message)
    ...
    @if($message->type==='invoice')
        ...
        @else
            <div class="left-message clearfix"><span class="message get-invoice"> Got Invoice for  £{{$message->invoice->amount()}}  &nbsp;&nbsp;  <span class="message-time"> {{$message->timestamp()}}</span></span>
                <span>
