                                ...
                                <form action="" method="get" id="form-filter-jobs">
                                    ...
                                    <div class="container-filter clearfix">
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" name="jobs_keywords" class="form-control" {{!isset($jobsKeywords)? : "value=\"".$jobsKeywords."\""}}>
                                        </div>
                                        <div class="col-md-5">
                                            ...
                                            <select class="form-control" name="jobs_status">
                                                ...
                                                <option value="{{$loop->index}}" {{!isset($jobsStatus)? : "selected"}}>{{$status}}</option>
                                                @endforeach
                                            </select>
                                        </div>
