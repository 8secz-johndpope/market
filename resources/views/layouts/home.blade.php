...
<head>
    ...
    <link href="{{ asset('/css/css/font-awesome.min?q=874') }}" rel="stylesheet">
                            ...
                            <div class="dropdown-menu options-user" role="menu">
                                ...
                                <div class="list-menu-common">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="nav-link nav-color" href="#"><span class="glyphicon glyphicon-list-alt"></span> &nbsp;&nbsp;Your Motors</a>
                                        </li>
                                        <li>
