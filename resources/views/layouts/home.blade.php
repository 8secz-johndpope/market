            ...
            <form class="navbar-form" action="/searchform" id="mainform">
                ...
                <div class="main-search-div">
                    ...
                    <div class="main-second-div inline-block-div">
                        ...
                        <input type="text" id="pac-input" class="form-control" placeholder="Location" name="location" value="@if($location->id!==0) @if($input['type']==='location') {{$location->title}} @else {{$postcode->postcode}} @endif @endif" required></div>
