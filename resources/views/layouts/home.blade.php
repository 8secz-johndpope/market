        ...
        <div class="col-sm-1   hidden-xs">
            ...
            <form class="navbar-form" action="/all" id="mainform">
                ...
                <div class="main-search form-group col-sm-12 col-xs-12 col-md-12 col-lg-12">
                    <div class="input-group col-sm-5 col-sm-offset-0 col-md-2 col-lg-2 col-lg-offset-2 col-xl-2 input-group-lg">
                    ...
                    </div><div class="input-group col-sm-6 col-md-7 col-lg-4 col-xl-8 input-group-lg">
                    ...
                    </div><div class="input-group col-sm-12 col-md-3 col-lg-3 col-xl-2 input-group-lg">
