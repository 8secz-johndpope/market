...
<span class="hide-visually">This ad is </span>Urgent
                        ...
                        @else
                    <table class="table"><tr><td><a class="nav-color" href="/user/advert/edit/{{$advert->id}}"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp; Edit</a></td><td><a  href="/user/advert/duplicate/{{$advert->id}}">Duplicate</a></td><td><a class="stats-click" data-id="{{$advert->id}}">Stats</a></td><td><a class="red-color" href="/user/advert/delete/{{$advert->id}}">Delete</a></td></tr></table>
                            @endif
                    </td>
                    @if($advert->has_param('draft'))
