...
<span class="hide-visually">This ad is </span>Urgent
                    ...
                    </td><td>0</td><td> <span class="posted">{{$advert->posted()}}</span></td><td><input name="matrix[{{$advert->id}}][featured_3]" type="checkbox" value="1"></td><td><input name="matrix[{{$advert->id}}][featured]" type="checkbox" value="1"></td><td><input name="matrix[{{$advert->id}}][featured_14]" type="checkbox" value="1"></td><td> @if($advert->urgent_expires()) {{$advert->urgent_expires()}} @else <input name="matrix[{{$advert->id}}][urgent]" type="checkbox" value="1"> @endif</td><td><input name="matrix[{{$advert->id}}][spotlight]" type="checkbox" value="1"></td><td><input name="matrix[{{$advert->id}}][bump]" type="checkbox" value="1"></td></tr>
            @endforeach
</table>
