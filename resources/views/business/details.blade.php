                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="balances">
                        ...
                        <table class="table">
                            ...
                            <tr><td>Available</td><td>{{$item['amount']}} nbsp; <span class="currency">{{$item['currency']}}</span> </td></tr>
                            @endforeach
                                @foreach($balance['pending'] as $item)
                                    <tr><td>Pending</td><td>{{$item['amount']}}  nbsp;<span class="currency">{{$item['currency']}}</span> </td></tr>
                                @endforeach
                    ...
                    <div class="user-cvs">
                        ...
                        @foreach($user->cvs as $cv)
                                <div class="address-div">
                                    ...
                                    @endif
                                    <a target="_blank" href="https://s3.eu-central-1.amazonaws.com/cv.eu-central-1.sumra.net/{{$cv->file_name}}">View/Download</a>
