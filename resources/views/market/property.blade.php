                    ...
                    <div class="reviews-ratings">
                        ...
                        <div class="row section-title">
                            ...
                            <div class="col-md-3 col-sm-3 tab-buttons">
                                <a class="btn btn-default btn-review" href="@if(Auth::guest())/login@else #make-review @endif">
                                    Write a review
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-3 tab-buttons">
                            ...
                            <div class="ratings">
                                ...
                                <div class="col-md-6 col-sm-6 col-ratings all-ratings">
                                    ...
                                    <div class="per-wrpr">
                                        @php
                                            $per = 100*$advert->user->ratings()->where('feedback',3)->count()/$advert->user->ratings()->count();
                                            if($per > 49){
                                                $degRight = 360;
                                                $degLeft = ($per * 360) / 100;
                                            }
