 		...
 		<div class="row">
 			<div class="col-sm-8">
 				<div class="docked-title">
					<h4>Uber</h4>
					<h3>Head of Public Policy UK& Ireland / Northern Europe</h3>
				</div>
 			</div>
 			<div class="col-sm-4">
 				<div class="docked-ctas">
					...
					<a class="tm-bright-blue-round-button apply-external" href="https://careers-uber.icims.com/jobs/35045/head-of-public-policy-uk%26-ireland---northern-europe/job?iis=&iisn=&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
						Apply Now 
		...
		<div class="row header-container">
			<div class="col-sm-12">
				<div id="top-image" class="bg-image">
					<h1>Head of Public Policy UK& Ireland / Northern Europe</h1>
								...
								<div class="bottom-ctas clearfix">
									<div class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
										<div class="external-apply center">
											<a class="tm-bright-blue-round-button btn-block apply-external" href="https://careers-uber.icims.com/jobs/35045/head-of-public-policy-uk%26-ireland---northern-europe/job?iis=&iisn=&mode=job" target="_blank" alt="Head of Public Policy UK& Ireland / Northern Europe - Apply Now">
												Apply Now 
												<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
											</a>
										</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
										<a class="tm-input-grey-round-button btn-block send-to-friend-btn" href="mailto:?Subject=Head of Public Policy UK& Ireland / Northern Europe&body=Just saw this awesome job I thought I would share with you! Check it out here: https://dev.sumra.net/jobs/uber/head-of-public-policy-uk-ireland-northern-europe?utm_source=job-individual" target="_blank">
											Send To A Friend
										</a>
									</div>
