        ...
        <div class="col-md-8 col-sm-12">
                ...
                <div class="">
                    ...
                    <ul class="nav nav-pills nav-stacked visible-xs">
                      <li><a data-toggle="pill" href="#tab-description">Description</a></li>
                      @if(count($product['images']) > 0)
                    ...
                    <div class="buttons">
                        <div class="details">
                            ...
                            <div class="user-details">
                                ...
                                <p class="link-about"><a class="btn btn-advertiser" href="/agent/{{$advert->user->id}}">Learn more about the Advertiser</a></p>
