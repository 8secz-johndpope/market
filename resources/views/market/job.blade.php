    ...
    <div class="job-container-bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-3 col-sm-offset-6 col-md-offset-0 col-xs-6 prev-next">
                    @if(isset($prevAdvert))
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-apply" class="tab-pane fade">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <div class="row apply-buttons">
                                        ...
                                        <div class="col-sm-12 create-profile-container">
                                            ...
                                            <br>
                                            <a class="btn btn-success" href="/job/profile/edit/general"> Create New Profile by {{env('APP_NAME')}}</a>
                                        </div>
                                        <div class="col-sm-12">
                                            <span class="h3">
                                            ...
                                            <br>
                                            <a class="btn btn-build-cv" href="/user/cv-builder/personal-details"> Create New CV - CV Builder by {{env('APP_NAME')}}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12 background-color collapse" id="apply-with-scv">
                                    <form action="/user/jobs/apply" method="post">
                                    <input name="redirect" type="hidden" value="{{$advert->url()}}">
                                    <input name="id" type="hidden" value="{{$advert->id}}">
                                    {{ csrf_field() }}
