 		...
 		<div class="row">
 			<div class="col-sm-8">
 				<div class="docked-title">
					<h4>Uber</h4>
					<h3>Head of Compliance - Uk & Ireland</h3>
				</div>
 			</div>
 			<div class="col-sm-4">
 				<div class="docked-ctas">
					...
					<a class="tm-bright-blue-round-button apply-external" href="https://careers-uber.icims.com/jobs/35086/head-of-compliance---uk-%26-ireland/job?iis=&iisn=&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
						Apply Now 
		...
		<div class="row header-container">
			<div class="col-sm-12">
				<div id="top-image" class="bg-image">
					<h1>Head of Compliance - Uk & Ireland</h1>
					<div class="ctas text-center">
						<a class="tm-bright-blue-round-button apply-external hidden-xs" href="https://careers-uber.icims.com/jobs/35086/head-of-compliance---uk-%26-ireland/job?iis=&iisn=&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
							Apply Now 
							<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
						</a>
					</div>
								...
								<div class="bottom-ctas clearfix">
									<div class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
										<div class="external-apply center">
											<a class="tm-bright-blue-round-button btn-block apply-external" href="https://careers-uber.icims.com/jobs/35086/head-of-compliance---uk-%26-ireland/job?iis=&iisn=&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
												Apply Now 
												<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
											</a>
										</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
										<a class="tm-input-grey-round-button btn-block send-to-friend-btn" href="mailto:?Subject=Head of Compliance - Uk & Ireland&body=Just saw this awesome job I thought I would share with you! Check it out here: https://dev.{{env('APP_NAME')}}.net/jobs/uber/head-of-compliance-uk-ireland?utm_source=job-individual" target="_blank">
											Send To A Friend
										</a>
									</div>
