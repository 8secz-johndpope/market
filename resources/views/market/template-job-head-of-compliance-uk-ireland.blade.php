 		...
 		<div class="row">
 			...
 			<div class="col-sm-4">
 				<div class="docked-ctas">
					...
					<a class="tm-bright-blue-round-button apply-external" href="https://careers-uber.icims.com/jobs/35086/head-of-compliance---uk-%26-ireland/job?iis=The+Muse&iisn=The+Muse&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
						Apply Now 
			...
			<div class="col-sm-12">
				<div id="top-image" class="bg-image">
					...
					<div class="ctas text-center">
						<a class="tm-bright-blue-round-button apply-external hidden-xs" href="https://careers-uber.icims.com/jobs/35086/head-of-compliance---uk-%26-ireland/job?iis=The+Muse&iisn=The+Muse&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
							Apply Now 
							<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
						</a>
					</div>
								...
								<div class="bottom-ctas">
									<div class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
										<div class="external-apply center">
											<a class="tm-bright-blue-round-button btn-block apply-external" href="https://careers-uber.icims.com/jobs/35086/head-of-compliance---uk-%26-ireland/job?iis=The+Muse&iisn=The+Muse&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
												Apply Now 
												<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
											</a>
										</div>
