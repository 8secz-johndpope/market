 		...
 		<div class="row">
 			<div class="col-sm-8">
 				<div class="docked-title">
					<h4>Uber</h4>
					<h3>Associate Counsel - UK & Ireland</h3>
				</div>
 			</div>
 			<div class="col-sm-4">
 				<div class="docked-ctas">
					...
					<a class="tm-bright-blue-round-button apply-external" href="https://careers-uber.icims.com/jobs/35059/associate-counsel---uk-%26-ireland/job?iis=The+Muse&iisn=The+Muse&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
						Apply Now 
								...
								<div class="bottom-ctas clearfix">
									...
									<div class="col-xs-12 visible-xs apply-later">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
											<a class="tm-input-grey-round-button btn-block send-to-friend-btn" href="mailto:?Subject=Safety Lead UKI&amp;body=Just saw this awesome job I thought I would share with you! Check it out here: https://dev.{{env('APP_NAME')}}.net/jobs/uber/safety-lead-uki?utm_source=job-individual" target="_blank">
												Send To A Friend
											</a>
										</div>
