 		...
 		<div class="row">
 			<div class="col-sm-8">
 				<div class="docked-title">
					<h4>Uber</h4>
					<h3>Senior Community Operations Manager, UberEATS - UKI</h3>
				</div>
 			</div>
 			<div class="col-sm-4">
 				<div class="docked-ctas">
					...
					<a class="tm-bright-blue-round-button apply-external" href="https://careers-uber.icims.com/jobs/29718/senior-community-operations-manager%2c-ubereats---uki/job?iis=&iisn=&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
						Apply Now 
		...
		<div class="row header-container">
			<div class="col-sm-12">
				<div id="top-image" class="bg-image">
					<h1>Senior Community Operations Manager, UberEATS - UKI</h1>
					<div class="ctas text-center">
						<a class="tm-bright-blue-round-button apply-external hidden-xs" href="https://careers-uber.icims.com/jobs/29718/senior-community-operations-manager%2c-ubereats---uki/job?iis=&iisn=&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
							Apply Now 
							<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
						</a>
					</div>
								...
								<div class="bottom-ctas clearfix">
									<div class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
										<div class="external-apply center">
											<a class="tm-bright-blue-round-button btn-block apply-external" href="https://careers-uber.icims.com/jobs/29718/senior-community-operations-manager%2c-ubereats---uki/job?iis=&iisn=&mode=job" target="_blank" alt="Safety Lead UKI - Apply Now">
												Apply Now 
												<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
											</a>
										</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
										<a class="tm-input-grey-round-button btn-block send-to-friend-btn" href="mailto:?Subject=Senior Community Operations Manager, UberEATS - UKI&body=Just saw this awesome job I thought I would share with you! Check it out here: https://dev.{{env('APP_NAME')}}.com/jobs/uber/senior-community-operations-manager-ubereats-uki?utm_source=job-individual" target="_blank">
											Send To A Friend
										</a>
									</div>
